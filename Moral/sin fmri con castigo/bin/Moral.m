...
log.castigo_inicio = cell(1, length(historias));
log.castigo_fin = cell(1, length(historias));
log.castigo_respuesta = cell(1, length(historias));
log.castigo_PrimerMovimiento = cell(1, length(historias));
...
for i = 1:length(historias)
    ...
    log.castigo_inicio{1,i} =log_respuesta.respuesta_inicio;
