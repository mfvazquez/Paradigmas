function EmocionesInstrucciones(instrucciones, TAMANIO_INSTRUCCIONES, botones, texto_botones, hd);
    ...
    DrawFormattedText(hd.window, char(botones{1}), 'center','center', hd.white, [],[],[],2,[],rect);      
    
    % TEXTO SOBRE LA TECLA
    rect = rect - diferencia_texto;
    Screen('TextSize', hd.window, tamanio_texto);
    DrawFormattedText(hd.window, texto_botones{1}, 'center','center', hd.white, [],[],[],2,[],rect);    
    ...
    % TECLA0
    Screen('TextSize', hd.window, tamanio_tecla);
    DrawFormattedText(hd.window, char(botones{2}), 'center','center', hd.white, [],[],[],2,[],rect);      
    
    % TEXTO SOBRE LA TECLA
    rect = rect - diferencia_texto;
    Screen('TextSize', hd.window, tamanio_texto);
    DrawFormattedText(hd.window, texto_botones{2}, 'center','center', hd.white, [],[],[],2,[],rect);    
